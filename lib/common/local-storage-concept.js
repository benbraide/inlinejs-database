...
exports.LocalStorageConcept = void 0;
const local_storage_wrapper_1 = require("./local-storage-wrapper");
class LocalStorageConcept {
    constructor() {
        this.wrappers_ = {};
    }
    Wrap(name) {
        return (this.wrappers_[name] || (this.wrappers_[name] = new local_storage_wrapper_1.LocalStorageWrapper(name)));
    }
    Open(name) {
...
exports.LocalStorageConcept = LocalStorageConcept;
